 ...
 */
public class LsodeBasicSimplePendulumTest extends SimplePendulumBase {
    @Test
    public void LsodeSimplePendulum() {
        ...
        IntValuedEnum<CodepackLibrary.codepack_ode_err_e> error =  CodepackLibrary.lsode_basic(stack, qq(), f_func, neq(), t0(),
                tf(), dt(),CodepackLibrary.codepack_method_e.ADAMS_BASIC);
        assertEquals("error on " + name , error,   CodepackLibrary.codepack_ode_err_e.SUCCESS);
